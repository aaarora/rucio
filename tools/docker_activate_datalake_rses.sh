...
rucio-admin rse set-attribute --rse DATALAKE_ORIGIN_2812 --key test_container_xrd --value True
...
rucio-admin rse set-attribute --rse DATALAKE_ORIGIN_2812 --key fts --value https://fts:8446
...
rucio-admin rse set-attribute --rse DATALAKE_ORIGIN_2812 --key available_for_multihop --value True

# Connect the RSEs
rucio-admin rse add-distance --distance 1 --ranking 1 T2_US_UCSD DATALAKE_ORIGIN_2811
rucio-admin rse add-distance --distance 1 --ranking 1 T2_US_UCSD DATALAKE_ORIGIN_2812
rucio-admin rse add-distance --distance 1 --ranking 1 DATALAKE_ORIGIN_2811 DATALAKE_ORIGIN_2812

# Indefinite limits for root
rucio-admin account set-limits root DATALAKE_ORIGIN_2811 -1
rucio-admin account set-limits root DATALAKE_ORIGIN_2812 -1
...
rucio add-rule scope$e:container$d 1 DATALAKE_ORIGIN_2812
